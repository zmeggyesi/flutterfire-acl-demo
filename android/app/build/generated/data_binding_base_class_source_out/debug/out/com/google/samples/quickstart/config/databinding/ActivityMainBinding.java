...
package com.google.samples.quickstart.config.databinding;
...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull Button fetchButton,
      @NonNull ImageView icon, @NonNull TextView welcomeTextView) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, fetchButton, icon,
          welcomeTextView);
    }
